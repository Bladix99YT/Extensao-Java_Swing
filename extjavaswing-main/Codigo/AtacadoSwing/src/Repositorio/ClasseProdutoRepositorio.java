...
public class ClasseProdutoRepositorio
    ...
    // Problema entre tipos (aqui ele usa uma List) no servico (vamos usar
    // polimorfismo colocamos em ReadArrayList a implementação da interface(Uma
    // conversão de tipos de list na interface para ArrayList))
    @Override
